...
A script to generate these data can be found in the `extdata` folder, which is easiest to find [here](https://github.com/jameshay218/virosolver/tree/master/man/inst/extdata).
...
p_ct_model_detectable <- ggplot(data.frame(p=prop_detect,t=test_ages)) + 
